...
<nav class="navbar" id="navigation">
    <div class="navbar-container">
      ...
      <ul class="navbar-right">
        ...
        <li> <button class="btn btn-dark"><a style="color:white;" href="/logIn/registerCustomer">Join now</a></button></li>
  ...
  <div class="smaller-menu hidden" id="menu">
    ...
    <button class="btn btn-outline-dark"><a href= "/logIn/logIn"> Sign in</a></button>
      <button class="btn btn-dark"><a style="color:white;" href="/logIn/registerCustomer" > Join now</a></button>
